...
/**
 * @brief The EUSCI_A3_SPI_Data_Read function receives data from the SPI receive buffer.
 *
 * This function receives data from the receive buffer of the EUSCI_A3 SPI module.
 * It waits until the receive buffer is empty before receiving the next data.
 *
